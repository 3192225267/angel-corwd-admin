        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-inline" action="admin/page.html" role="form" style="float:left;">
                    ...
                    <a class="btn btn-primary" style="float:right;" href="admin/to/add/user.html"><i class="glyphicon glyphicon-plus"></i> 新增</a>
                    <br>
                    <hr style="clear:both;">
                    <div class="table-responsive">
                        <table class="table  table-bordered">
                            ...
                            <c:if test="${empty requestScope.pageInfo.list}">
                                <tr>
                                    <td colspan="6" align="center">抱歉，没有查询到相关数据</td>
                                </tr>
                            </c:if>
                            <c:if test="${!empty requestScope.pageInfo.list }">
                                <c:forEach items="${requestScope.pageInfo.list}" var="a" varStatus="myStatus">
                                    <tr>
                                        ...
                                        <td>${a.loginAcct }</td>
                                        <td>${requestScope.pageInfo.pageNum}</td> <td>${a.email }</td>
                                        <td>
                                            ...
                                            <a href="/admin/edit/${a.id}/${requestScope.pageInfo.pageNum}/${param.keyWord}.html" class="btn btn-primary btn-xs"><i class=" glyphicon glyphicon-pencil"></i></a>
    ...
    function initPagination() {
     ...
     var totalRecord = ${requestScope.pageInfo.total};
      // 声明 Pagination 设置属性的 JSON 对象
        var properties = { num_edge_entries: 3,// 边缘页数
