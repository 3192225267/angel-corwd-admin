        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" id="adminFrom" action="/admin/edit.html" method="post">
                        ...
                        <%--<div class="form-group">--%>
                            ...
                            <%--<input type="text" class="form-control" name="userPswd" value="${loginAdmin.userPswd}" id="exampleInputPassword1" placeholder="请输入用户密码">--%>
                        <%--</div>--%>
                        <div class="form-group">
                        ...
                        <button id="btn1" type="submit" class="btn btn-success"><i class="glyphicon glyphicon-edit"></i> 修改</button>
                        <button type="button" class="btn btn-danger"><i class="glyphicon glyphicon-refresh"></i> 清空</button>
                    </form>
                </div>
            </div>
        </div>
